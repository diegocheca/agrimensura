...
<body>
        ...
        <p> Nos comunicamos desde el Colegio de Profesionales Agrimensores de San Juan. 
            Para comunicarle que el expdiente, con numero: {{$num_expe}}, ha sido calificado como un expediente que requiere ser subsanado por el area: <strong> {{$nombre_area}}</strong></p>
        <p>Esto requiere de su intervención.</p>
        <hr>
        <br>
        <h4>La subsanacion es:</h4>
        <p>{{ $subsanacion }}</p>
        <br>
        <hr>
        <p>Para remediar esta situacion debe asistir en persona por la mesa de entrada de la DGR, con domicilio .... y telefono interno: ....</p>
