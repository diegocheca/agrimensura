<template>
    <div>
        ...
        <button id="show-modal" @click="showModal = true" class="btn btn-primary"> ver Movi</button>
        <button id="show-modal" @click="showModal = true" class="btn btn-success"> Mover</button>
...
export default {
  ...
  created(){
    axios.get('/movimientos/3').then(res=>{
      this.notas = res.data;
