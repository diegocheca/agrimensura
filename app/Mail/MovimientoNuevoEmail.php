...
class MovimientoNuevoEmail extends Mailable
{
     ...
     * @return void
     */
    public function __construct($nombre, $fecha_entrada, $comentario, $bandera_observacion, $nombre_area, $tramite_finalizado, $id_expediente, $num_expe )
    {
        //
        $this->name = $nombre;
